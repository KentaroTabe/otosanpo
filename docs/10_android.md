...
## エミュレータ(2026-09-19 に用意・**まだ起動できていない**)
...
この Mac の空きは 4.5 GB しか無い(2026-09-19 時点・460 GB のうち 99% 使用)。

**設定では下げられないことを実測で確かめた:**
...
空きを作る以外に手が無い。両スクリプトは**起動前に空きを見て、足りなければ
必要な GB 数を言って止まる**ようにしてある。
